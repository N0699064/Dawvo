            ...
            <div className="space-y-20">
              {layers.map((layer, index) => (
                <div 
                  ...
                  style={getVisibility(600 + index * 200, 5 + index)}
                >
                    ...
                    <div className="flex-1">
                      ...
                      <ul className="space-y-2 mb-4">
                        {layer.points.map((point, idx) => (
                          <li key={idx} className="text-sm text-gray-700 font-light flex items-start">
          ...
          <div className="px-8">
            ...
            >
              ...
              <ul className="space-y-2 mb-6">
                <li className="text-sm text-gray-700 font-light flex items-start">
                  <span className="text-gray-400 mr-3">•</span>
