  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-white z-50">
      <div className="px-8 py-8">
        <div className="border-2 border-black px-12 py-8 flex justify-between items-center">
          ...
          <div className="flex items-center gap-12">
            {navLinks.map((link) => (
              <Link
                key={link.path}
                to={link.path}
                className={`text-xs font-normal tracking-wide transition-all duration-300 hover:text-[#2E7D32] uppercase ${
